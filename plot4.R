...
#plot 4_1_1
plot(working_set$Date,working_set$Global_active_power,type="l",ylab = "Global Active Power (kilowatts)",xlab = "")

#plot 4_1_2
plot(working_set$Date,working_set$Voltage,type="l",ylab = "Voltage",xlab = "datetime")
